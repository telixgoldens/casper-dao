...
const DAO_CONTRACT_HASH = process.argv[2] || process.env.DAO_CONTRACT_HASH || 'hash-5602ff70a5643b82d87302db480387a62d5993a5d2c267e8e88fd93a14e5c368';
// Optional token contract hash for voting as second CLI arg or env var. If omitted, the DAO contract hash is used.
const TOKEN_CONTRACT_HASH = process.argv[3] || process.env.TOKEN_CONTRACT_HASH || 'hash-c27539ac84749caebee898677d44fd3344b1772cbaf99f72897f47aad40cfea1';
...
async function main() {
  ...
  const tokenTypeArg = process.argv[4] || process.env.TOKEN_TYPE || 'u256_address';
